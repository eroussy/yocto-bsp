...
Here is a description of flavors:
   ...
   * observer_bios: bios observer image (used to observer the cluster)
...
during a PXE boot.
* Observer images
** seapath-observer-[FW]: production image for an observer (needed for clustering quorum establishment)
